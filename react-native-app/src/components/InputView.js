...
export default function InputView(props) {
  ...
  const drawContent = () => {
    const stTextInput = valueInput
      ? {
          ...styles.styleTextInput,
          ...styleTextInput,
           //editable ? 'black' : placeholderTextColor,
        }
      : stPlaceholder;
    return (
      <TextInput
  ...
  return (
    <TouchableOpacityEx style={styleContains} onPress={handleOnPress}>
...
const styles = StyleSheet.create({
  ...
  styleTextInput: {
    ...
    color: 'black',
    minHeight: Dimension.heightDefault,
  },
