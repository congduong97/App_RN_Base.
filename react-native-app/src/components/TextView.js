  ...
  if (nameIconLeft) {
    ...
    return (
      <IconView
        ...
        size={sizeIconLeft || constants.sizeIconText}
        color={colorIconLeft || constants.colorIcon}
      />
    );
  }
}
  ...
  if (nameIconRight) {
    ...
    return (
      <IconView
        ...
        size={sizeIconRight || constants.sizeIconText}
        color={colorIconRight || constants.colorIcon}
      />
    );
  }
}
...
const styles = StyleSheet.create({
  ...
  styleTitle: {
    ...
    fontSize: constants.fontSizeTitleText,
    color: 'gray',
    fontStyle: 'italic',
  },
