...
import {DEVICE_WIDTH, tab, screen} from '../../const/System';
import {STRING} from '../../const/String';
import {APP_COLOR, COLOR_BLACK, COLOR_GRAY_LIGHT} from '../../const/Color';

import ItemNotification from '../NotificationScreen/Item/ItemNotification';
  ...
  getApi = async () => {
    ...
    try {
      ...
      if (title === STRING.notification_important) {
        ...
        console.log('getNotificationNormal', result);
      }
